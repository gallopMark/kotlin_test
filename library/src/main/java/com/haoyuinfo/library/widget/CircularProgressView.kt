...
class CircularProgressView(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : View(context, attrs, defStyleAttr) {
    ...
    init {
        ...
        mBorderWidth = a.getDimension(R.styleable.CircularProgressView_border_Width, resources.getDimension(R.dimen.circular_default_border_width))
        ...
        if (isInEditMode) {
            mColors = IntArray(4)
            mColors[0] = ContextCompat.getColor(context, R.color.colorPrimary)
            mColors[1] = ContextCompat.getColor(context, R.color.colorPrimary)
            mColors[2] = ContextCompat.getColor(context, R.color.colorPrimary)
            mColors[3] = ContextCompat.getColor(context, R.color.colorPrimary)
        } else {
